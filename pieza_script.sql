...
CREATE TABLE IF NOT EXISTS `PiezaP-P`.`P-P` (
  ...
  CONSTRAINT `fk_PIEZA_has_PIEZA_PIEZA`
    FOREIGN KEY (`PIEZA_Cod-pieza-Continente`)
    REFERENCES `PiezaP-P`.`PIEZA` (`Cod-pieza`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PIEZA_has_PIEZA_PIEZA1`
    FOREIGN KEY (`PIEZA_Cod-pieza-Contenido`)
    REFERENCES `PiezaP-P`.`PIEZA` (`Cod-pieza`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
