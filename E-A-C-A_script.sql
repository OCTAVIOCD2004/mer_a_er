...
CREATE TABLE IF NOT EXISTS `5.8.1`.`ARQUITECTO` (
  ...
  CONSTRAINT `fk_ARQUITECTO_FACULTAD1`
    FOREIGN KEY (`FACULTAD_Cod-facultad`)
    REFERENCES `5.8.1`.`FACULTAD` (`Cod-facultad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `5.8.1`.`ALBAÑIL` (
  ...
  CONSTRAINT `fk_ALBAÑIL_CAPATAZ1`
    FOREIGN KEY (`CAPATAZ_cod-empleado`)
    REFERENCES `5.8.1`.`CAPATAZ` (`cod-empleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `5.8.1`.`E-A` (
  ...
  CONSTRAINT `cod-edificio`
    FOREIGN KEY (`Cod-edificio`)
    REFERENCES `5.8.1`.`EDIFICIO` (`cod-edificio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `cod-empleado`
    FOREIGN KEY (`Cod-empleado`)
    REFERENCES `5.8.1`.`ARQUITECTO` (`cod-empleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `5.8.1`.`E-AL` (
  ...
  CONSTRAINT `fk_E-AL_ALBAÑIL1`
    ...
    REFERENCES `5.8.1`.`ALBAÑIL` (`cod-empleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_E-AL_EDIFICIO1`
    FOREIGN KEY (`EDIFICIO_cod-edificio`)
    REFERENCES `5.8.1`.`EDIFICIO` (`cod-edificio`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `5.8.1`.`A-H` (
  ...
  CONSTRAINT `fk_A-H_HERRAMIENTA1`
    ...
    REFERENCES `5.8.1`.`HERRAMIENTA` (`Cod-herramienta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
